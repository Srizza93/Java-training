...
public class PhoneNumberApp {
	...
	public static void main(String[] args) {
		String filename = "/Users/martina/eclipse-workspace/JavaTraining/Files/PhoneNumber.txt";
		...
		for (int i = 0; i < phoneNums.length; i++){
			...
			try {
				...
				System.out.println("ERROR: Phone numer is not 10 digits");
